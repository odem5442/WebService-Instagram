...
#     PL_FILES => {  }
#     PREREQ_PM => { strict=>q[0], Test::More=>q[0], warnings=>q[0], LWP::UserAgent=>q[0], URI=>q[0], Data::Dumper=>q[0], JSON=>q[0], HTTP::Request=>q[0], Carp=>q[0] }
...
DISTVNAME = WebService-Instagram-0.04
